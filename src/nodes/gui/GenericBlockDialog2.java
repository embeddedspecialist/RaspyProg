...
/*
 * GenericBlockDialog2.java
 *
 * Created on 15-lug-2010, 13.50.31
 */
 ...
 * @author newtohm
 */
public class GenericBlockDialog2 extends javax.swing.JDialog {
 /** A return status code - returned if Cancel button has been pressed */
    public static final int RET_CANCEL = 0;
    /** A return status code - returned if OK button has been pressed */
    public static final int RET_OK = 1;
    /** Creates new form GenericBlockDialog2 */
    public GenericBlockDialog2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(raspyprog.RaspyProgApp.class).getContext().getResourceMap(GenericBlockDialog2.class);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
         if ( FieldChecker.checkStringIsNumeric(txtField1.getText()) &&
             FieldChecker.checkStringIsNumeric(txtField2.getText())
           ){
            returnStatus = RET_OK;
            setVisible(false);
        }
  ...
  //  public static void main(String args[]) {
    //    java.awt.EventQueue.invokeLater(new Runnable() {
      //      public void run() {
        //        GenericBlockDialog2 dialog = new GenericBlockDialog2(new javax.swing.JFrame(), true);
