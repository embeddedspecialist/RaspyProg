 ...
 * @author amirrix
 */
public class BinaryEncoderNode extends GenericNode {

    public BinaryEncoderNode(String id, String label, AFOGraphPinScene scene) {
        super(id, label, scene);
        blockType = CommonDefinitions.blockTypes.BinaryEncoder;
    ...
    private void CreateWidget() {
        ...
        ((AFONodeWidget)widget).setName("Encoder");
    ...
    public String getIniString(int deviceIndex) throws Exception {
        ...
        retVal +="NAME:BINARYENCDEC,TYPE:ENC"+","+getCommonData()+"COMMENT:"+comment;
